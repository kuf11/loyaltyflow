(()=>{
  ...
  panel.innerHTML=`<div class="analytics-head"><div><div class="eyebrow">Аналитика</div><h2>Подробная статистика</h2><p>Продажи, возврат клиентов и состояние бонусной программы.</p></div><div class="analytics-source">Метрики построены по подходам CRM и RFM-аналитики программ лояльности.</div></div><div class="analytics-grid" id="analyticsMetrics"></div><div class="analytics-details"><article class="card"><div class="section-title"><div><h2>Сегменты клиентов</h2><p>Упрощённый RFM-анализ по давности и частоте покупок.</p></div></div><div class="segment-list" id="analyticsSegments"></div></article><article class="card"><div class="section-title"><div><h2>Как читать показатели</h2><p>Короткие формулы и назначение.</p></div></div><div class="analytics-guide"><div><b>Средний чек</b><small>Выручка ÷ количество покупок.</small></div><div><b>Повторные клиенты</b><small>Покупатели с двумя и более покупками среди последних 100 операций.</small></div><div><b>Активные за 30 дней</b><small>Клиенты с регистрацией или операцией за последние 30 дней.</small></div><div><b>RFM-сегменты</b><small>Группировка по давности последней покупки, частоте и сумме трат.</small></div></div></article></div>`;
